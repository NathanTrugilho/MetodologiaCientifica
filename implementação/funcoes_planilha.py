...
def filtra_dados(arquivo_entrada):
    ...
    planilha_filtrado.to_csv("dados.csv", index=False)
...
def dividir_csv():
    ...
    planilha = pd.read_csv('dados.csv')
...
def csv_para_excel():
    ...
    df = pd.read_csv("resultados/equacoes.csv")
...
arquivo_entrada = '/Users/Nathan/Desktop/Planinha_IC.xlsx' 
